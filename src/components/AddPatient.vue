         ...
         <div class="columns grid-xs">
              <div class="column col-mx-auto col-4 col-xs-10 col-xl-4   col-l-5 col-md-8">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-input" id="lastname" type="text" placeholder="Prénom" @keyup="forumalerror = false " v-model="patient.lastname">

                    <label class="form-label" for="phone">Téléphone</label>
                    <input class="form-input" id="phone" type="number" placeholder="Numéro de téléphone" @keyup="forumalerror = false " v-model="patient.phone">

                    <label class="form-label" for="age">Age</label>
                    <input class="form-input" id="nom" type="number" placeholder="Age" @keyup="forumalerror = false " v-model="patient.age">

                    <label class="form-label" for="sexe">Sexe</label>
                    <select class="form-select" placeholder="sexe" @keyup="forumalerror = false " v-model="patient.gender">
